...
model = joblib.load("ddi_lr_model.pkl")
tfidf = joblib.load("ddi_tfidf.pkl")
...
st.title("💊 AI-Based Drug Interaction Risk Predictor")
st.write("Predicts the risk of adverse drug–drug interactions using Explainable AI.")
